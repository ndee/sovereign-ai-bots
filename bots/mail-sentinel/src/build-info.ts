/**
 * Immutable build identity for the running Mail Sentinel bundle.
 *
...
declare const __MAIL_SENTINEL_VERSION__: string | undefined;
declare const __MAIL_SENTINEL_COMMIT__: string | undefined;
...
/*  Reading the defines is the one part the test runner cannot reach: vitest
    ...
    to whatever comes back is covered by the readDefine tests above. */
/* v8 ignore start -- tsup `define` substitution never occurs under vitest. */
const rawVersion = (): unknown =>
  typeof __MAIL_SENTINEL_VERSION__ === "undefined" ? undefined : __MAIL_SENTINEL_VERSION__;
const rawCommit = (): unknown =>
  typeof __MAIL_SENTINEL_COMMIT__ === "undefined" ? undefined : __MAIL_SENTINEL_COMMIT__;
