...
3. Read the matching playbook in `references/`
4. Build a response with decisions, risks, documents, and next steps
5. Offer a relocation or due-diligence plan when the user needs a concrete action list
